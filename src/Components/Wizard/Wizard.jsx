...
const Wizard = ({positionTop}) => {
   
   return (
      <div className={stylewizard.wizard} style={{top: `${positionTop}px`}}>
         <div className={stylewizard.wizard__container}>
            ...
            <NavLink to="/resultado" className={stylewizard.wizard__wizarditem}>
            ...
            <NavLink to="/playlist" className={stylewizard.wizard__wizarditem}>
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

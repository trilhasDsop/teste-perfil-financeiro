  ...
  playlists: [
    {
      ...
      url_foto: '../../assets/capas/Superendividado/Eu mereço ter dinheiro.png',
      link_url: 'linkurl'
    }
  ]
},
...
export const Resultado = () => {
  const {resultado, respostas} = React.useContext(DataContext)
  ...
  const playlist = playlistPerfil
    .filter(({perfil}) => perfil === resultadoPerfil.perfil)
      ...
      <section className={styleResultado.sectionResultado__container}>
        ...
        <article className={styleResultado.sectionResultado__article2Container}>
          ...
          {questoes?.map((questao) => (
            <article key={questao[0]} className={styleHome.section1__home__article}>
              <h2>{questao[1]}</h2>
